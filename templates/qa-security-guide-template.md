...
| **Style Guide**     | Are code style conventions (naming, folder structure) documented?       | _Optional_               |                    |
...
| **Security Review**   | Is there a mandatory security review process for major features/releases?                 | _Optional_                    |                    |
